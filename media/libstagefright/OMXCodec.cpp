...
status_t OMXCodec::configureCodec(const sp<MetaData> &meta) {
    ...
    if (!strcasecmp(MEDIA_MIMETYPE_VIDEO_RV, mMIME)) {
...
status_t OMXCodec::setFFmpegVideoFormat(const sp<MetaData> &meta)
{
    ...
    err = mOMX->setParameter(mNode, OMX_IndexParamVideoFFmpeg, &param, sizeof(param));
...
status_t OMXCodec::setFFmpegAudioFormat(const sp<MetaData> &meta)
{
    ...
    status_t err = mOMX->getParameter(mNode, OMX_IndexParamAudioFFmpeg, &param, sizeof(param));
    ...
    err = mOMX->setParameter(mNode, OMX_IndexParamAudioFFmpeg, &param, sizeof(param));
